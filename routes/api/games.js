...
//get a list of requestors history - not working with req.user
// router.get('/request_history', gamesCtrl.requestor_history);

// //get a list of goalie history - not working with req.user
...
// //create a new game (anyone) - Not working with req.user
...
//add a goalie to an active request - Not working with req.user
